...
public class MesosSchedulerAdaptorImpl implements MesosSchedulerAdaptor {
  ...
  public static MesosSchedulerServerBuilder newBuilder() {
    return new MesosSchedulerServerBuilder();
  }

  MesosSchedulerAdaptorImpl(MesosSchedulerServerBuilder builder, Scheduler scheduler, MesosMaster master, FrameworkInfo frameworkInfo) {
